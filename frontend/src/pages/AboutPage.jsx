...
function AboutPage() {
  return (
    <MainLayout>
      {/* Grid Container */}
      <div
        className="grid gap-6 grid-cols-1 p-4 text-white md:grid-cols-4 md:grid-rows-2"
      >
        {/* Box 1 */}
        ...
        {/* Box 3 */}
        <div
          className="hidden p-10 rounded-xl text-gray-900 bg-white md:block md:row-span-2"
        >
          {/* Box Header */}
          <div className="flex space-x-4">
            <img
